...
function traduzirHtml(html) {
  ...
  const correcoesIntegrais = [
    ...
    ['Guia de Taxes do Brazil', 'Brazilian Taxes Guide'],
    ['Guia de taxes do Brazil', 'Brazilian taxes guide'],
    [
      'taxes, contributions, fees and charges no Brazil — 78 siglas',
      'taxes, contributions, fees and charges in Brazil — 78 acronyms',
    ],
    [
